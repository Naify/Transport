#include "techlpaadmissionmodel.h"
...
TechLpaAdmissionModel::TechLpaAdmissionModel(int vcId, QObject *parent):
...
TechLpaAdmissionModel::~TechLpaAdmissionModel()
{
}

void TechLpaAdmissionModel::init()
{
    load();
}

void TechLpaAdmissionModel::load()
{
    ...
    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска к ЛПА",filter);
...
void TechLpaAdmissionModel::makeRow(const ODS::IObject &obj)
{
...
void TechLpaAdmissionModel::addEmptyRow()
{
    QList<QStandardItem*> list;
...
void TechLpaAdmissionModel::choosePerson()
{
...
void TechLpaAdmissionModel::remove(const QModelIndex &index)
{
...
bool TechLpaAdmissionModel::save()
{
    ...
    for (int i = 0; i< rowCount(); i++){
        ...
        if (id > 0)
            ...
            obj = ODS::OdsInterface::self()->iobjectManager().createIObject("Допуска КП.Допуска к ЛПА");
...
bool TechLpaAdmissionModel::saveItem(QStandardItem *item, ODS::IObject &obj)
{
...
void TechLpaAdmissionModel::changeVc(int vcId)
{
    removeRows(0, rowCount());
    currentVcid = vcId;

    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска к ЛПА",
