...
MechItemDelegate::MechItemDelegate(QObject *parent):
    QItemDelegate(parent)
{
}

MechItemDelegate::~MechItemDelegate()
{
}

QWidget *MechItemDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &, const QModelIndex &index) const
{
    switch(index.data(MechModel::TypeRole).toInt())
    {
    case MechModel::Num:
    {
...
void MechItemDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const
{
...
//    case MechModel::NumAndDate:
    ...
    model->setData(index.sibling(index.row(), 0), true, MechModel::ChangedRole);
}
