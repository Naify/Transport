#ifndef AKADMISSIONMODEL_H
#define AKADMISSIONMODEL_H
...
class AkAdmissionModel : public QStandardItemModel
{
    Q_OBJECT
public:
    enum FieldType{
    ...
    AkAdmissionModel(int vcId, QObject *parent = 0);
    ~AkAdmissionModel();
