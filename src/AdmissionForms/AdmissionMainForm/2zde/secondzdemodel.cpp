...
SecondZdeModel::SecondZdeModel(int vcId, QObject *parent) :
...
SecondZdeModel::~SecondZdeModel()
{
}

void SecondZdeModel::init()
{
    load();
}

void SecondZdeModel::load()
{
    ...
    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска 2ЗНЖДЭ",filter);
...
void SecondZdeModel::makeRow(const ODS::IObject &obj)
{
...
void SecondZdeModel::addEmptyRow()
{
    QList<QStandardItem*> list;
...
void SecondZdeModel::choosePerson()
{
...
void SecondZdeModel::remove(const QModelIndex &index)
{
...
bool SecondZdeModel::save()
{
    ...
    for (int i = 0; i< rowCount(); i++){
        ...
        if (id > 0)
            ...
            obj = ODS::OdsInterface::self()->iobjectManager().createIObject("Допуска КП.Допуска 2ЗНЖДЭ");
...
bool SecondZdeModel::saveItem(QStandardItem *item, ODS::IObject &obj)
{
...
void SecondZdeModel::changeVc(int vcId)
{
    removeRows(0, rowCount());
    currentVcid = vcId;

    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска 2ЗНЖДЭ",
