#ifndef SECONDZDEMODEL_H
#define SECONDZDEMODEL_H
...
class SecondZdeModel : public QStandardItemModel
{
    Q_OBJECT
public:
    enum FieldType{
    ...
    SecondZdeModel(int vcId, QObject *parent = 0);
    ~SecondZdeModel();
