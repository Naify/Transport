...
SiAdmissionModel::SiAdmissionModel(int vcId, QObject *parent):
...
SiAdmissionModel::~SiAdmissionModel()
{
}

void SiAdmissionModel::init()
{
    load();
}

void SiAdmissionModel::load()
{
    ...
    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска к СИ",filter);
...
void SiAdmissionModel::makeRow(const ODS::IObject &obj)
{
...
void SiAdmissionModel::addEmptyRow()
{
    QList<QStandardItem*> list;
...
void SiAdmissionModel::choosePerson()
{
...
void SiAdmissionModel::remove(const QModelIndex &index)
{
...
bool SiAdmissionModel::save()
{
    ...
    for (int i = 0; i< rowCount(); i++){
        ...
        if (id > 0)
            ...
            obj = ODS::OdsInterface::self()->iobjectManager().createIObject("Допуска КП.Допуска к СИ");
...
bool SiAdmissionModel::saveItem(QStandardItem *item, ODS::IObject &obj)
{
...
void SiAdmissionModel::changeVc(int vcId)
{
    removeRows(0, rowCount());
    currentVcid = vcId;

    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска к СИ",
