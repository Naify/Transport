...
SoprAdmissionModel::SoprAdmissionModel(int vcId, QObject *parent):
...
SoprAdmissionModel::~SoprAdmissionModel()
{
}

void SoprAdmissionModel::init()
{
    load();
}

void SoprAdmissionModel::load()
{
    ...
    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска сопровождающие",filter);
...
void SoprAdmissionModel::makeRow(const ODS::IObject &obj)
{
...
void SoprAdmissionModel::addEmptyRow()
{
    QList<QStandardItem*> list;
...
void SoprAdmissionModel::choosePerson()
{
...
void SoprAdmissionModel::remove(const QModelIndex &index)
{
...
bool SoprAdmissionModel::save()
{
    ...
    for (int i = 0; i< rowCount(); i++){
        ...
        if (id > 0)
            ...
            obj = ODS::OdsInterface::self()->iobjectManager().createIObject("Допуска КП.Допуска сопровождающие");
...
bool SoprAdmissionModel::saveItem(QStandardItem *item, ODS::IObject &obj)
{
...
void SoprAdmissionModel::changeVc(int vcId)
{
    removeRows(0, rowCount());
    currentVcid = vcId;

    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска сопровождающие",
