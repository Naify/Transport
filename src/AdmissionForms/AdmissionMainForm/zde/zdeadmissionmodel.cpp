...
ZdeAdmissionModel::ZdeAdmissionModel(int vcId, QObject *parent):
...
ZdeAdmissionModel::~ZdeAdmissionModel()
{
}

void ZdeAdmissionModel::init()
{
    load();
}

void ZdeAdmissionModel::load()
{
    ...
    ODS::IObjectCursor cursor = ODS::OdsInterface::self()->iobjectManager().getIObjectCursor("Допуска КП.Допуска ЗНЖДЭ",filter);
...
void ZdeAdmissionModel::makeRow(const ODS::IObject &obj)
{
...
void ZdeAdmissionModel::addEmptyRow()
{
    QList<QStandardItem*> list;
...
void ZdeAdmissionModel::choosePerson()
{
...
void ZdeAdmissionModel::remove(const QModelIndex &index)
{
...
bool ZdeAdmissionModel::save()
{
    ...
    for (int i = 0; i< rowCount(); i++){
        ...
        if (id > 0)
            ...
            obj = ODS::OdsInterface::self()->iobjectManager().createIObject("Допуска КП.Допуска ЗНЖДЭ");
...
bool ZdeAdmissionModel::saveItem(QStandardItem *item, ODS::IObject &obj)
{
...
void ZdeAdmissionModel::changeVc(int vcId)
{
    removeRows(0, rowCount());
    currentVcid = vcId;
